...
function mostrarFraseAleatoria(){
    ...
    const fraseAleatoria = frasesFrikisInformatica[indiceAleatorio];
    const pElemento = document.getElementById("texto-informatica");


    pElemento.textContent = `${fraseAleatoria} (indice: ${indiceAleatorio})`;
}